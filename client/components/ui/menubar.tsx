...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-sm px-1 py-1.5 text-sm font-medium outline-none   data-[state=open]:bg-transparent data-[state=open]:text-accent-foreground",
      className
    )}
    {...props}
  />
